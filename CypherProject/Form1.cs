...
namespace CypherProject
{
    public partial class Form1 : Form
    {
        ...
        private void transpostionEncrypted_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            textBox4.Text = security.GetEncrypto(textBox3.Text, textBox5.Text);
        ...
        {
            textBox5.Text = security.GetDecrypto(textBox3.Text, textBox4.Text);
